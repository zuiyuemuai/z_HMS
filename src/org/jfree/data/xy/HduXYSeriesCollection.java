 ...
 * dataset.
 */
public class HduXYSeriesCollection extends AbstractIntervalXYDataset implements
		IntervalXYDataset, DomainInfo, RangeInfo, PublicCloneable, Serializable
{
	 ...
	 */
	public HduXYSeriesCollection(XYSeries series)
	{
	...
	/**
	 * 修改其中一个系列
	 * @param index	该系列在list中的位置
	 * @param series 替换的数据
	 */
	public void setSeries(int index, XYSeries series)
	{
		if (series == null)
		{
			throw new IllegalArgumentException("Null 'series' argument.");
		...
		{
			throw new IllegalArgumentException("index over.");
		}
	 ...
	 *             if <code>key</code> is not found in the collection.
	 * 
	 * @since 1.0.9
	 */
	...
	public boolean equals(Object obj)
	{
		...
		if (!(obj instanceof HduXYSeriesCollection))
		{
			return false;
		}
		HduXYSeriesCollection that = (HduXYSeriesCollection) obj;
	...
	{
		HduXYSeriesCollection clone = (HduXYSeriesCollection) super.clone();
		clone.data = (List) ObjectUtilities.deepClone(this.data);
		clone.intervalDelegate = (IntervalXYDelegate) this.intervalDelegate
				.clone();
		return clone;
	}
