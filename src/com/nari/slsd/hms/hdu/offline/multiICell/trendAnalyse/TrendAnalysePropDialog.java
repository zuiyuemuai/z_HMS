...
public abstract class TrendAnalysePropDialog extends PropDialog
{
	public TrendAnalysePropDialog(Vector<WorkSpaceProp> workSpaceProps)
	{
	...
	protected void JcomBoxsSelectHandle(JComboBox choise)
	{
		...
		if (choise == pathBox)// 如果改变了站点的话
		{
			...
			addItem(id);
			table.setValueAt(workSpaceProps.get(choise.getSelectedIndex()).sectionName.get(0), 2, 1);
