...
public abstract class HduCreatWord
{
	...
	public HduCreatWord(String outputPath, String ModeName)
	{
		this(null, outputPath, ModeName);
	}
	...
	public void createWord()
	{
		...
		getData(dataMap);
		try
		{//change lqj 1_28 改成了从文件系统获取,其他代码不受影响
			configuration.setDirectoryForTemplateLoading(new File("wordModel"));
